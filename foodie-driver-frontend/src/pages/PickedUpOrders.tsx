...
//       );
//       console.log("Fetched picked up orders:", response.data.status);
//       setOrders(filtered);
//     } catch (err) {
//       toast({
//         title: "Error",
//         description: "Failed to fetch picked up orders.",
//         variant: "destructive",
//       });
//     } finally {
//       setLoading(false);
...
//         <h1 className="text-2xl font-bold mb-4">📦 Picked Up Orders</h1>
...
//                   Order #{order.id}
//                   <Badge className="bg-blue-500 text-white">Picked Up</Badge>
//                 </CardTitle>
//               </CardHeader>
